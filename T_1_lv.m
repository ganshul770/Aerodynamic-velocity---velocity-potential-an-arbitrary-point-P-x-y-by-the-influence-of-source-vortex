...
%%
%constant linear vortex strength
...
% x1=0;z1=0;x2=1;z2=0;g=1;n=1;g1=1;g2=2;

%%
%velocity at any point P(x,z)
[ux,uz]=linearvortex_velolcity(x1,z1,x2,z2,g,n,g1,g2);
...
[phi_s]=linearvortex_potential(x1,z1,x2,z2,g,n,g1,g2);
% a=phi(1,1);
